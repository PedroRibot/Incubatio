...
class Skeleton():
    ...
    def setJointRotations(self, rotations):
        ...
        # 0  : RightHand
        #rotations[0,:] = t3d.quaternions.qmult(t3d.euler.euler2quat(np.pi / 2.0, 0.0, 0.0, axes='sxyz'), rotations[0,:])
        # 1  : RightHandThumb1
        ...
        rotations[4,:] = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, np.pi / 2.0, axes='sxyz'), rotations[4,:])    
        # 5  : RightHandIndex1
        ...
        for pjI in range(self.jointCount):
            ...
            for cjI in children:
                ...
                if pjI == 0 and cjI == 1: # RightHand to RightHandThumb1
                    edgeRotation = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, -np.pi * 0.26, axes='sxyz'), edgeRotation)
                if pjI == 0 and cjI == 5: # RightHand to RightHandIndex1
                    edgeRotation = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, -np.pi * 0.46, axes='sxyz'), edgeRotation)
                if pjI == 0 and cjI == 9: # RightHand to RightHandMiddle1
                    edgeRotation = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, -np.pi * 0.5, axes='sxyz'), edgeRotation)      
                if pjI == 0 and cjI == 13: # RightHand to RightHandRing1
                    edgeRotation = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, -np.pi * 0.54, axes='sxyz'), edgeRotation)   
                if pjI == 0 and cjI == 17: # RightHand to RightHandPinky1
                    edgeRotation = t3d.quaternions.qmult(t3d.euler.euler2quat(0.0, 0.0, -np.pi * 0.58, axes='sxyz'), edgeRotation)   
                """
